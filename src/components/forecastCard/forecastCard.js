...
export const NextDays = ({forecast, timezone, sunrise, sunset}) => {
        ...
        <div className="forecast_wrapper">
            <div className="forecast">
                <div className='forecast_inner'>
                    ...
                    <img className='forecast_img' src={iconWeather(forecast?.weather[0]?.main, timezone, sunrise, sunset, forecastHours.getHours() )} alt=''/>
